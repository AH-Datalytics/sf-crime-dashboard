...
import { aggregateMonthly } from "@/lib/measures/cfs-measures";
...
export function CfsTrendChart() {
  ...
  return (
    <div className="border border-[#e8e8e8] rounded-lg bg-white p-4">
      <p className="text-xs font-mono uppercase tracking-wider text-gray-400 mb-3">Monthly Call Volume</p>
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={monthly} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
          ...
          <Tooltip formatter={(v) => [(v ?? 0).toLocaleString(), "Calls"]} labelFormatter={labelFormatter} contentStyle={{ fontSize: 12, border: "1px solid #d4d4d4", boxShadow: "none" }} />
